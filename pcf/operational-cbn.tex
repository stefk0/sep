...
\marginpar{Да напомним, че с $\vv{v}$ означаваме стойности, които биват или константи или затворени термове от вида $\lamb{x}{a}{\mu}$.
  ...
  Обрнете внимение, че заради случая (fix) не можем да доказваме свойства на операционната семантика с индукция по построението на термовете. Можем да направим това с индукция по броя на стъпки в изчислението.}
