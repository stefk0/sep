...
\begin{figure}[H]
  ...
  \begin{prooftree}
    ...
    \UnaryInfC{$\Gamma \vdash \tru : \vv{bool}$}
  \end{prooftree}
\end{subfigure}
...
\begin{subfigure}[b]{0.5\textwidth}
  ...
  \UnaryInfC{$\Gamma \vdash \fls : \vv{bool}$}
\end{prooftree}
\end{subfigure}
~
\begin{subfigure}[b]{0.5\textwidth}
...
\begin{subfigure}[b]{0.5\textwidth}
\begin{prooftree}
  \AxiomC{$\Gamma \vdash \tau:\vv{nat}$}
  \RightLabel{\scriptsize{(succ)}}
  \UnaryInfC{$\Gamma \vdash \scc(\tau) : \vv{nat}$}
\end{prooftree}
\end{subfigure}
~
\begin{subfigure}[b]{0.5\textwidth}
\begin{prooftree}
  \AxiomC{$\Gamma \vdash \tau:\vv{nat}$}
  \RightLabel{\scriptsize{(pred)}}
  \UnaryInfC{$\Gamma \vdash \prd(\tau) : \vv{nat}$}
\end{prooftree}
\end{subfigure}
...
\begin{prooftree}
  \AxiomC{$\Gamma \vdash \tau:\vv{nat}$}
  \RightLabel{\scriptsize{(iszero)}}
  \UnaryInfC{$\Gamma \vdash \iszero(\tau) : \vv{bool}$}
\end{prooftree}
\end{subfigure}
~
\begin{subfigure}[b]{0.5\textwidth}
...
\begin{subfigure}[b]{0.5\textwidth}
\begin{prooftree}
  \AxiomC{$\Gamma \vdash \tau_1:\vv{bool}$}
  \AxiomC{$\Gamma \vdash \tau_2:\vv{a}$}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    \begin{prooftree}
      \AxiomC{$\tau_1 \Downarrow^{\ell_1}_{\bool} \fls$}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    \begin{prooftree}
      \AxiomC{$\tau_1 \Downarrow^{\ell_1}_{\bool} \tru$}
...
\begin{problem}(Теорема за коректност)
