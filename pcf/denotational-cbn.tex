...
\marginpar{Формално погледнато, трябва да се обясни какво е $\val{\emptyset}$.
Например може да се дефинира $\emptyset_\bot = (\{\bot\},\sqsubseteq,\bot)$ и $\val{\emptyset} \dff \emptyset_\bot$.}
