...
Типовите контексти представляват крайни редици от двойки от вида $\type{x}{a}$.
Обикновено ще означаваме типовите контексти с главните гръцки $\Gamma, \Delta, \dots$.
\marginpar{С други думи, \[\Gamma ::= \emptyset\ |\ \Gamma,\type{x}{a}.\]}
...
Сега ще дефинираме релация, която ще ни казва кои термове са добре типизирани относно дадения типов контекст.
