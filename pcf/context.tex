...
\begin{proof}
  ...
  От (3) на \Lem{pcf:relation} имаме, че
  ...
  Отново от (3) на \Lem{pcf:relation} имаме, че $\val{\rho} \triangleleft_{\vv{a} \to \nat} \rho$.
...
% Неформално, тази теорема ни казва, че ако два програмни фрагмента имат една и съща семантика (операционна ,
% то в произволна програма (контекст) можем да заменим единия фрагмент с другия без да можем да открием
% разлика в при изпълнението на новата програма спрямо първоначалната. Формално, това е следното следствие.
\begin{framed}
  \begin{theorem}
