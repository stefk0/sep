...
\begin{proof}
  ...
  \marginpar{Да напомним, че $\val{\vv{nat}} \dff \Nat_\bot$.}
  \begin{enumerate}[1)]
  \item
  ...
  \marginpar{Да напомним, че \[\val{\vv{b} \to \vv{c}} \dff \Cont{\val{\vv{b}}}{\val{\vv{c}}}.\]}
  \begin{enumerate}[1)]
  \item
...
\begin{proof}
  ...
  \item
    ...
    Нека за улеснение да положим $f \dff \val{\tau'}(\ov{u}) \in \Cont{\val{\vv{a}}}{\val{\vv{a}}}$.
    Да напомним, че
