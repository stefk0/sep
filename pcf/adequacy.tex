...
\begin{example}
  ...
  \item
    ...
    \begin{prooftree}
      ...
      \UnaryInfC{$\tau \opsemGen{}{\arr{nat}{nat}} \lamb{x}{nat}{\vv{x + 0}}$}
...
\begin{proof}
  ...
  \marginpar{Имаме от (\ref{eq:pcf:adequacy:implication:value}), че 
    \[\tau \Downarrow_{\arr{b}{c}} \vv{v} \implies \rho \Downarrow_{\arr{b}{c}} \vv{v},\] а тук $\vv{v} \equiv \lamb{x}{b}{\tau'}$.}
  \begin{prooftree}
    \AxiomC{$\tau \Downarrow_{\arr{b}{c}} \overbrace{\lamb{x}{b}{\tau'}}^{\vv{v}}$}
  ...
  \begin{prooftree}
    \AxiomC{$\rho \Downarrow_{\arr{b}{c}} \overbrace{\lamb{x}{b}{\tau'}}^{\vv{v}}$}
    \AxiomC{$\tau'\subst{x}{\mu} \Downarrow_{\vv{c}} \vv{v}'$}
    \RightLabel{\scriptsize{(app)}}
...
\begin{proof}
  ...
  \item
    ...
    \begin{prooftree}
      \AxiomC{$\Gamma \vdash \tau_1 : \arr{b}{a}$}
  ...
  \item
    ...
    \begin{prooftree}
      ...
      \UnaryInfC{$\lamb{y}{b}{\tau'[\ov{x}/\ov{\mu}]} \Downarrow_{\arr{b}{c}} \lamb{y}{b}{\tau'[\ov{x}/\ov{\mu}]} $}
