...
\begin{center}
  \begin{tikzcd}[sep=large]
    \Partial{\Nat^n}{\Nat} \arrow[r, "\Gamma"] & \Partial{\Nat^n}{\Nat} \arrow[d, "\Sigma^\star"]\\
    \Strict{\Nat^n_\bot}{\Nat_\bot} \arrow[u, "(\Sigma^\star)^{-1}"]\arrow[r, dashed, "\mathcal{G}(\Gamma)"] & \Strict{\Nat^n_\bot}{\Nat_\bot}
  \end{tikzcd}
\end{center}
\shorthandon{"}%
