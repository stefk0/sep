...
\marginpar{
  ...
  Също така, няма как да дефинираме релация $\tau \Downarrow L$, където $L$ е език, защото все пак искаме всяко изчисление да трае краен брой стъпки, а това няма как да стане, когато $L$ е безкраен език.
}
...
Щом сме фиксирали програмата, с която искаме да работим, това означава, че вече знаем и буквите, които се срещат в програмата,
