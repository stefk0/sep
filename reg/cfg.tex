  ...
  \begin{figure}[H]
    \begin{subfigure}[b]{0.5\textwidth}
      \begin{prooftree}
        ...
        \UnaryInfC{$\varepsilon \opsem{0}{G} \varepsilon$}
      \end{prooftree}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.5\textwidth}
    ...
    \begin{subfigure}[b]{0.5\textwidth}
      \begin{prooftree}
        \AxiomC{$\tau_1 \opsem{\ell}{G} \alpha$}
        \LeftLabel{\scriptsize{(left-or)}}
        \UnaryInfC{$\tau_1 + \tau_2 \opsem{\ell+1}{G} \alpha$}
      \end{prooftree}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.5\textwidth}
      \begin{prooftree}
        \AxiomC{$\tau_2 \opsem{\ell}{G} \alpha$}
    ...
    \begin{subfigure}[b]{0.5\textwidth}
      \begin{prooftree}
        \AxiomC{$\tau_i \opsem{\ell}{G} \alpha$}
        \LeftLabel{\scriptsize{(rec)}}
        \UnaryInfC{$X_i \opsem{\ell+1}{G} \alpha$}
      \end{prooftree}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.5\textwidth}
      \begin{prooftree}
        \AxiomC{$\tau_1 \opsem{\ell_1}{G} \alpha_1$}
        \AxiomC{$\tau_2 \opsem{\ell_2}{G} \alpha_2$}
        \RightLabel{\scriptsize{(concat)}}
        \BinaryInfC{$\tau_1 \cdot \tau_2 \opsem{\ell_1+\ell_2+1}{G} \alpha_1\cdot\alpha_2$}
      \end{prooftree}
    \end{subfigure}
