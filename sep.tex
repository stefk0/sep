...
\usepackage{amssymb, amsmath, amsthm, mathrsfs, bm}
\usepackage{stmaryrd}
\usepackage{latexsym}
\usepackage{makeidx}
...
\usepackage[colorlinks=true, linkcolor=blue, pdfstartview=FitV,citecolor=blue, urlcolor=blue]{hyperref}
\usepackage[pdfauthor={Stefan Vatev}, pdftitle={Semantics of Programming Languages}, colorlinks=true, linkcolor=blue, pdfstartview=FitV, citecolor=green, urlcolor=blue]{hyperref}
...
% \include{imp}
% \include{Operators}
\include{domains-basic/domains-basic}
