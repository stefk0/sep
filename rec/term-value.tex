...
\item
  \marginpar{От \Problem{basic-operations:if} знаем, че $\texttt{if}$ е непрекъснато изображение.}
...
\begin{proof}
  ...
  \marginpar{Това твърдение е без доказателство в \cite[стр. 188]{ditchev-soskov}.}
  \begin{itemize}
  \item
