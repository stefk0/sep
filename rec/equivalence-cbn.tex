...
\begin{prop}
  ...
  \marginpar{За това твърдение не е необходимо $\bar{\gamma}$ да бъде най-малката неподвижна точка на $\Gamma$}
...
\begin{proof}
  ...
  \item
    ...
    \marginpar{Озн. $\ov{\gamma} = (\gamma_1,\dots,\gamma_n)$. Единствено в този случай се използва, че $\ov{\gamma}$ е решение на системата от оператори}
