...
\begin{lemma}\label{lem:rec:functional:term:continuous}
  ...
  \marginpar{Да напомним, че $m_i \df \#\vv{f}_i$}
  Да разгледаме произволна верига $\chain{\ov{\varphi}}{r}$
  от елементи на областта на Скот
  \[\DomOpCBN.\]
...
\begin{proof}
  ...
  \item
    ...
    \begin{align*}
      \val{\mu}(\bigsqcup_r \ov{\varphi}_r) & \df \texttt{plus}(\val{\mu_1}(\bigsqcup_r\ov{\varphi}_r), \val{\mu_2}(\bigsqcup_r\ov{\varphi}_r))\\
      ...
      & \df \bigsqcup_r \val{\mu}(\ov{\varphi}_r).
    \end{align*}
  \item
  ...
  \item
    ...
    \[e_{n,r} \df \varphi^i_{n}(\val{\mu_1}(\ov{\varphi}_r),\dots,\val{\mu_{m_i}}(\ov{\varphi}_r)),\]
    то
    ...
    \begin{align*}
      \val{\mu}(\bigsqcup_n\ov{\varphi}_n) & = \val{\vv{f}_i(\mu_1,\dots,\mu_{m_i})}(\bigsqcup_n\ov{\varphi}_n)\\
                                           & \df (\bigsqcup_n\varphi^i_n)(\val{\mu_1}(\bigsqcup_r\ov{\varphi}_r),\dots,\val{\mu_{m_i}}(\bigsqcup_r\ov{\varphi}_r))\\
                                           ...
                                           & \df \bigsqcup_n \val{\vv{f}_i(\mu_1,\dots,\mu_{m_i})}(\ov{\varphi}_n)\\
